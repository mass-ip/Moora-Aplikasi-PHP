...
<!-- navbar -->
    ...
    <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
            <div class="navbar-nav ml-auto">
                <a class="nav-item nav-link active" href="data_ikm.php">Data</a>
                <a class="nav-item nav-link active" href="data_bantuan.php">Data hasil hitung</a>
                <a class="nav-item nav-link active" href="data_kriteria.php">Info</a>
                <a class="nav-item btn btn-primary tombol" href="../login.php">Login Admin</a>
            </div>
        </div>
    </div>
    </nav>
